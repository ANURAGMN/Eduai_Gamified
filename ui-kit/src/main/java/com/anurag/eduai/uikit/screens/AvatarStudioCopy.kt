...
fun defaultAvatarStudioCopy(): AvatarStudioCopy =
    AvatarStudioCopy(
        ...
        saved = "Saved ✓",
        saveWithAds = "Save · 1 ad",
        shareWithFriends = "Share with friends",
        saveHint = "Watch 1 ad to save. Your tutor appears on Home and in celebrations.",
        saveAdFailed = "Could not finish the ad. Your tutor look was not saved — try again.",
        weeklyAvatars = "This week's avatars",
        newInDays = { days -> if (days == 1) "New in 1 day" else "New in $days days" },
        unlockHint = "Watch 1 ad to unlock. Yours to keep and share.",
        use = "Use",
        share = "Share",
        unlockWithAds = "Unlock · 1 ad",
        locked = "Locked",
