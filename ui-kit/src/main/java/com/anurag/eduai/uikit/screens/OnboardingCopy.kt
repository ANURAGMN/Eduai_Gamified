...
data class OnboardingStrings(
    ...
    val backWorld: String,
    val pickTutorTitle: String,
    val pickTutorSub: String,
...
private fun english(): OnboardingStrings =
    OnboardingStrings(
        ...
        backChapter = "Chapter",
        backWorld = "World",
        pickTutorTitle = "Meet your tutor",
        pickTutorSub = "Pick who'll guide you — you can change it anytime.",
...
private fun kannada(): OnboardingStrings =
    OnboardingStrings(
        ...
        backChapter = "ಅಧ್ಯಾಯ",
        backWorld = "ಜಗತ್ತು",
        pickTutorTitle = "ನಿಮ್ಮ ಶಿಕ್ಷಕರನ್ನು ಭೇಟಿಯಾಗಿ",
        pickTutorSub = "ನಿಮಗೆ ಮಾರ್ಗದರ್ಶನ ನೀಡುವವರನ್ನು ಆರಿಸಿ — ಯಾವಾಗ ಬೇಕಾದರೂ ಬದಲಿಸಬಹುದು.",
        surpriseMe = "ಯಾವುದಾದರೂ",
