...
object AvatarStudioCopyFactory {
    ...
    private fun kannada() =
        AvatarStudioCopy(
            ...
            expression = "ಭಾವನೆ",
            saved = "ಉಳಿಸಲಾಗಿದೆ ✓",
            saveWithAds = "ಉಳಿಸಿ · 2 ಜಾಹೀರಾತುಗಳು",
            shareWithFriends = "ಸ್ನೇಹಿತರೊಂದಿಗೆ ಹಂಚಿಕೊಳ್ಳಿ",
            saveHint = "ಉಳಿಸಲು 2 ಜಾಹೀರಾತುಗಳನ್ನು ನೋಡಿ. ನಿಮ್ಮ ಶಿಕ್ಷಕ ಮುಖಪುಟ ಮತ್ತು ಆಚರಣೆಗಳಲ್ಲಿ ಕಾಣಿಸುತ್ತಾರೆ.",
            saveAdFailed = "ಎರಡೂ ಜಾಹೀರಾತುಗಳು ಪೂರ್ಣಗೊಳ್ಳಲಿಲ್ಲ. ನಿಮ್ಮ ಶಿಕ್ಷಕರ ರೂಪ ಉಳಿಸಲಾಗಿಲ್ಲ — ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.",
            weeklyAvatars = "ಈ ವಾರದ ಅವತಾರಗಳು",
            newInDays = { days -> if (days == 1) "1 ದಿನದಲ್ಲಿ ಹೊಸದು" else "$days ದಿನಗಳಲ್ಲಿ ಹೊಸದು" },
            unlockHint = "ಅನ್ಲಾಕ್ ಮಾಡಲು 2 ಜಾಹೀರಾತುಗಳನ್ನು ನೋಡಿ. ನಿಮ್ಮದಾಗಿ ಇರಿಸಿ ಮತ್ತು ಹಂಚಿಕೊಳ್ಳಿ.",
            use = "ಬಳಸಿ",
            share = "ಹಂಚಿಕೊಳ್ಳಿ",
            unlockWithAds = "ಅನ್ಲಾಕ್ · 2 ಜಾಹೀರಾತುಗಳು",
            locked = "ಲಾಕ್",
